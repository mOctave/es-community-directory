...
const DIRECTORY = {
	...
	arachi: {
		...
		roles: ["Core Member", "Coalition Lead"],
	...
	bene_dictator: {
		...
		description: `The current longest-active writing reviewer and one of the GitHub organization's moderators. Not too active on GitHub anymore, although they tend to show up every once in a whiel on the Discord server.`,
	...
	hurleveur: {
		...
		roles: ["Reviewer", "Code Patrol", "Unfettered Lead"],
	...
	master_of_grey: {
		...
		roles: ["Community Organizer", "Moderator", "Hai Lead"],
	...
	saugia: {
		...
		roles: ["Developer", "Art Patrol", "Gegno Lead", "Pirate Lead"],
